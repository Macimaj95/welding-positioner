...
FreeRTOS::StaticBinarySemaphore fbuf_sem;
//StaticQueue<uint16_t, 1> vsync_queue;
FreeRTOS::StaticMutex vsync_mutex;
...
void OSWrappers::giveFrameBufferSemaphoreFromISR()
{
  ...
  fbuf_sem.giveFromISR(higherPriorityTaskWoken);

  Kernel::yieldFromISR(higherPriorityTaskWoken);
}
...
{
  bool higherPriorityTaskWoken;
  vsync_mutex.lockFromISR(higherPriorityTaskWoken);
